...
hobby= 'Pokemon Go'
role_model= 'Dr. Martin Luther King Jr.'
famous_quote= 'Injustice anywhere is a threat to justice everywhere'
fav_president= 'Abraham Lincoln'
fav_food= 'Burgers'
fav_color= 'Blue'
fav_song= 'Same Love by Macklemore'
...
fav_number= 11
yen_rate= 110.79
bitcoin_value= 6307.87
todays_temperature= 79
hawaii_population= 1430102
...
fab_five= ['oreos', 'mochi crunch', 'li hing mango', 'hello panda', 'funyuns']
print(fab_five)
...
plate_lunch= ['chicken katsu curry', 'bbq chicken', 'bacon ultimate cheeseburger', 'baconator', 'honey garlic chicken']
print(plate_lunch)
...
ice_cream= ['mint chocolate chip', 'chocolate', 'rocky road']
print(ice_cream)
...
hamajang= ['string', 'number', 'list', 'dictionary', 'tuple', 'boolean']
print(hamajang)
...
dynamic_duos= [['peanut butter', 'jelly'], ['batman', 'robin'], ['nuts', 'bolts']]
print(dynamic_duos)
#Print the following:
#Gin
...
pandas['cuisine']= 'Gourment Chinese Food'
...
bucket_list= {}
bucket_list['travel']= 'London'
bucket_list['learn']= 'Multiple Languages'
bucket_list['weight']= 300
bucket_list['to_dos']= ['Drive the Autobahn', 'Backpack Across Europe', 'Wrestle a Bear', 'Play in some Snow']
bucket_list['meet_person']= 'Nobuo Uematsu'
print(bucket_list)
